...
public interface NHttpServletFacadeContext {
    ...
    String getRequestHeader(String header) throws NIOException;

    List<String> getRequestHeaders(String header) throws NIOException;

    InputStream getRequestBody() throws NIOException;

    <T> T getRequestBodyAs(Class<T> type, NContentType contentType) throws NIOException;

    byte[] getRequestBodyAsBytes() throws NIOException;

    String getRequestBodyAsString() throws NIOException;

    Map<String, List<String>> getRequestParameters() throws NIOException;
    ...
    NOptional<String> getRequestParameter(String name);
