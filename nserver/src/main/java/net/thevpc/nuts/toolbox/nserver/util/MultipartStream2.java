 ...
 * ====================================================================
 */
package net.thevpc.nuts.toolbox.nserver.util;
...
import net.thevpc.nuts.toolbox.nserver.bundled._IOUtils;
...
public class MultipartStream2 {
    ...
    public static class ProgressNotifier {
        ...
        /**
         * Number of bytes, which have been skip so far.
         */
        private long bytesRead;

        /**
         * Number of items, which have been skip so far.
         */
        private int items;
        ...
        /**
         * Called to indicate that bytes have been skip.
         *
         * @param pBytes Number of bytes, which have been skip.
         */
        void noteBytesRead(int pBytes) {
            /* Indicates, that the given number of bytes have been skip from
             * the input stream.
             */
            bytesRead += pBytes;
            notifyListener();
    ...
    // ----------------------------------------------------------- Data members
    /**
     * The input stream from which data is skip.
     */
     ...
     *
     * @return The encoding used to skip part headers.
     */
     ...
     * default encoding is used.
     *
     * @param encoding The encoding used to skip part headers.
     */
     ...
     * @throws FileUploadIOException if the bytes skip from the stream exceeded
     * the size limits
     ...
     * @throws IllegalBoundaryException if the <code>boundary</code> has a
    ...
    public int readBodyData(OutputStream output)
        ...
        return (int) Streamscopy(newInputStream(), output, false); // N.B. Streams.copy closes the input stream
    }
    ...
    public class ItemInputStream extends InputStream implements Closeable {
        ...
        /**
         * The number of bytes, which have been skip so far.
         */
        private long total;
        ...
        private void findSeparator() {
            pos = MultipartStream2.this.findSeparator();
            if (pos == -1) {
         ...
         *
         * @return Number of bytes, which have been skip so far.
         */
         ...
         * @return Number of bytes, which have been actually skip, or -1 for
         * EOF.
         * @throws IOException An I/O error occurred.
         */
        @Override
         ...
         * Closes the input stream.
         *
         * @param pCloseUnderlying Whether to close the underlying stream (hard
         * close)
         * @throws IOException An I/O error occurred.
         */
    ...
    private class FileUploadIOException extends IOException {
    }

    private class FileItemStreamItemSkippedException extends IOException {
    }
}
